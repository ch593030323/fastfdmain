...
w_scr_dish_pay_dialog::w_scr_dish_pay_dialog(w_scr_dish_pay_widget::operatModes m, QWidget *parent, const fexpandmain_model_sqltablemodel_data *tablemodel, int print_int_flowid_max) :
    ...
    ui(new Ui::w_scr_dish_pay_dialog)
{
    ...
    ui->frame_main->initdataByM(tablemodel, print_int_flowid_max);
