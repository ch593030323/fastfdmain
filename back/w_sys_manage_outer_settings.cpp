...
void w_sys_manage_outer_settings::retranslateView()
{
    ...
    backlist_model->model_data_set(7, 0,QObject::tr("平板/厨显/电话盒"),Qt::UserRole);
    backlist_model->model_data_set(7, 0,model_tablet,Qt::UserRole + 1);

    backlist_model->model_data_set(8, 0,QObject::tr("邮箱"),Qt::UserRole);
    backlist_model->model_data_set(8, 0,model_email,Qt::UserRole + 1);
#endif
