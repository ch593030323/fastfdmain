...
public slots:
    void toprintBill(const QString &bp_ch_billno, const QString &bp_languageKey, int label_flowid_greater_than, int pay_print_mode);
    void toprintBill(const QString &bp_ch_billno, const QString &bp_languageKey, int label_flowid_greater_than, int pay_print_mode,
                     const QImage &image);
...
signals:
    void signalTrigger(const QString &bp_ch_billno, const QString &bp_languageKey, int label_flowid_greater_than, int pay_print_mode);
    void signalTrigger(const QString &bp_ch_billno, const QString &bp_languageKey, int label_flowid_greater_than, int pay_print_mode, const QImage &img);
public:
    void emitsignalTrigger(const QString &bp_ch_billno, const QString &bp_languageKey, int label_flowid_greater_than, int pay_print_mode);
    void emitsignalTrigger(const QString &bp_ch_billno, const QString &bp_languageKey, int label_flowid_greater_than, int pay_print_mode, const QImage &img);
    //from QThread
protected:
    virtual void run();
};
