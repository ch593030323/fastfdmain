...
public:
    lds_network();
    static bool managerPost(const QNetworkRequest &request, const QByteArray &body, QByteArray &readall, QString &errstring, int &httpcode);
    static bool managerGet(const QNetworkRequest &request, QByteArray &readall, QString &errstring, int &httpcode);
};
