...
fexpandmain_2::ReadMemType fexpandmain_2::to_m_read(QWidget *parent, fexpandmain_model_sqltablemodel_data *tablemodel, const QString &localMemberNo)
{
...
bool fexpandmain_2::static_toquit_1_suit(QString &errstring, qlonglong int_flowid, double &dishnum_back_total, const QString &vch_reason, const QString &operid, const QDateTime &dt, QList<num_backData> &d_list)
{
    ...
    foreach(const num_backData &d, d_list) {
        if(!static_toquit_1_only(errstring, d)) {
            return false;
        }
    }
    return true;
...
bool fexpandmain_2::static_toquit_1_suit_list(QString &errstring, qlonglong int_flowid, double &dishnum_back_total, const QString &vch_reason, const QString &operid, const QDateTime &dt, QList<num_backData> &d_list)
{
    lds_query_hddpos  query;
    lds_query_hddpos  query2;
    QString ch_suitflag;
