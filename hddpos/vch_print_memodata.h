...
public:
    ...
    QString jsonToString(double num_x = 1);
    ...
    void duplicate(const QString &no, double num = 1);
    ...
    void from100110(const QString &str100110);

    void print();

    void sub(const vch_print_memoData &other);
