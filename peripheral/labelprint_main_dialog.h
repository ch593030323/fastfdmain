...
public:
    ...
    //
    static QString print_piece_POSTEK(QStandardItemModel *model, const SSRPairMap &ssrmap, printer_label_postek &printer, int rr, int start_x = 0);
    static QString print_piece_TSC(QStandardItemModel *model, const SSRPairMap &ssrmap, printer_label_tsc_ttp_244_plus &printer, int rr, int start_x = 0);
    static QString print_piece_ARGOX_PPLA(QStandardItemModel *model, const SSRPairMap &ssrmap, printer_label_argox_PPLA &printer, int rr, int start_x = 0);
    static QString print_piece_ARGOX_PPLB(QStandardItemModel *model, const SSRPairMap &ssrmap, printer_label_argox_PPLB &printer, int rr, int start_x = 0);
    static QString print_piece_GAINSCHA(QStandardItemModel *model, const SSRPairMap &ssrmap, printer_label_gainscha &printer, int rr, int start_x = 0);
    static QString print_piece_HPRT(QStandardItemModel *model, const SSRPairMap &ssrmap, printer_label_tsc_HPRT &printer, int rr, int start_x = 0);
