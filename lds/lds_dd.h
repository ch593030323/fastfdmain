...
public:
    lds_dd() {}
     ...
     static const int SYS_DOUBLE_SCREEN_PORT;
...
//        QString sum_total_desc;//{"name":"金额", "value":"12.6"}
    ...
    //
    static QString pair2json(const QList<QPair<QString, QString> > &pair_list);
    static QList<QPair<QString, QString> > json2pair(const QString &json);
};
